        ...
        <div class="container-fluid page-header py-5">
            <h1 class="text-center text-white display-6">ForgotPassword</h1>
                    ...
                    <div class="row g-4">
                        ...
                        <div class="col-lg-12">
                            <div class="h-100 rounded">
                                <form @submit.prevent="forgotSubmission" class="">
                                    <input type="email" 
                                        class="w-100 form-control border-0 py-3 mb-4" 
                                        placeholder="Enter Your Email" 
                                        autocomplete="off" 
                                        v-model="forgot.forgotPasswordEmail" 
                                        name="user_email" 
                                        @input="forgotPasswordInputFieldValidation('email')"
                                    >
                                    <p v-if="errors.forgot.forgotPasswordEmailError" class="error text-danger">{{ errors.forgot.forgotPasswordEmailError }}</p>
      
                                    <button 
                                        class="w-100 btn form-control border-secondary py-3 bg-white text-primary " 
                                        type="submit"
                                    >
                                        <i v-if="forgot.buttonLoaderFlag"class="fa bi bi-hourglass-top me-2 text-white"></i>
                                        <p v-else>Submit</p>
                                    </button>
                                </form>
                            </div>
